...
console.log(coche1===coche2)//<--- No compara valores compara 
console.log(coche.modelo===coche2.modelo)//<--- comparacion de valores
var coche3=coche1;
console.log(coche1===coche3)//<-- ambos tienen la misma referecia